      ...
      <View style={[styles.compactContainer, { height }]}>
        ...
        <Svg width="100%" height="100%" viewBox="0 0 160 80" preserveAspectRatio="xMidYMid slice">
          ...
          <G transform="translate(10, 8)">
            {/* Ground Line */}
            <Line x1="5" y1="44" x2="135" y2="44" stroke="#E31837" strokeWidth="1.2" strokeOpacity="0.7" />
            ...
            <Circle cx="38" cy="44" r="3" fill="#E31837" />
            <Circle cx="102" cy="44" r="7" fill="#0F172A" stroke="#E2E8F0" strokeWidth="1.2" />
            <Circle cx="102" cy="44" r="3" fill="#E31837" />
          </G>
        </Svg>
  ...
  return (
    <View style={[styles.container, { height }]}>
      ...
      <Svg width="100%" height="100%" viewBox="0 0 340 160" preserveAspectRatio="xMidYMid meet">
        ...
        <Line x1="170" y1="15" x2="170" y2="25" stroke="#E31837" strokeWidth="1.5" />
        <Line x1="165" y1="20" x2="175" y2="20" stroke="#E31837" strokeWidth="1.5" />

        {/* Dynamic Datum / Ground Reference Line with Tech Markers */}
        <Line x1="20" y1="126" x2="320" y2="126" stroke="#E31837" strokeWidth="1.5" strokeOpacity="0.8" />
        <Circle cx="20" cy="126" r="2.5" fill="#E31837" />
        <Circle cx="320" cy="126" r="2.5" fill="#E31837" />
        ...
        <G transform="translate(20, 26)">
          ...
          <Circle cx="76" cy="94" r="3.5" fill="#E31837" />
          ...
          <Circle cx="204" cy="94" r="3.5" fill="#E31837" />
      ...
      <View style={styles.bottomOverlay}>
        ...
        <Text style={styles.specSubText}>
          {car?.engine || car?.fuel || car?.powerKw ? `${car.engine || ''} • ${car.fuel || ''} • ${car.powerKw ? car.powerKw + 'kW' : ''}`.replace(/^ • | • $/g, '') : 'KYB SUSPENSION GENUINE FITMENT SPECIFIED'}
        </Text>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  yearPill: {
    backgroundColor: 'rgba(227, 24, 55, 0.85)',
    paddingHorizontal: 7,
    paddingVertical: 3,
    borderRadius: 6,
  },
