...
export function HomeDashboard3DIcon({ size = 32, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="24" cy="16" r="2.5" fill="#E31837" />
...
export function DrawerAvatar3DIcon({ size = 36, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="34" cy="34" r="7" fill="#E31837" stroke="#FFFFFF" strokeWidth="2" />
...
export function FindParts3DIcon({ size = 32, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Line x1="20" y1="22" x2="20" y2="25" stroke="#E31837" strokeWidth="1.6" strokeLinecap="round" />
...
export function MyGarage3DIcon({ size = 32, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="15" cy="34" r="2" fill="#E31837" />
      <Circle cx="33" cy="34" r="5" fill="#1E293B" stroke="#E2E8F0" strokeWidth="1.5" />
      <Circle cx="33" cy="34" r="2" fill="#E31837" />
    </Svg>
  );
}
...
export function DealerLocator3DIcon({ size = 32, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="24" cy="42" r="3" fill="#E31837" />
...
export function TickerLiveRadarIcon({ size = 18, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
      <Circle cx="12" cy="12" r="9" stroke="#E31837" strokeWidth="2" strokeDasharray="3 2" />
      <Circle cx="12" cy="12" r="5" fill="#FEE2E2" />
      <Circle cx="12" cy="12" r="2.5" fill="#E31837" />
    </Svg>
  );
}
...
export function OwnerRole3DIcon({ size = 36, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="13" cy="35" r="2" fill="#E31837" />
      <Circle cx="35" cy="35" r="5" fill="#0F172A" stroke="#FFFFFF" strokeWidth="1.5" />
      <Circle cx="35" cy="35" r="2" fill="#E31837" />
...
export function DistributorRole3DIcon({ size = 36, ...props }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      <Circle cx="35" cy="37" r="1.8" fill="#E31837" />
    </Svg>
  );
}
