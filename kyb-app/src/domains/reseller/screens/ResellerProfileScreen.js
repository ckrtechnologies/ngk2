    ...
    <View style={styles.container}>
      ...
      <View style={[styles.headerBar, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerSubtitle}>KYB TRADE & WORKSHOP</Text>
        </View>
      ...
      >
          ...
          <View style={styles.pendingNoticeCard}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.pendingNoticeBody}>
                Your reseller account is currently being vetted by KYB administration. Once verified, your workshop will automatically be activated on the live Authorized Stockists directory.
              </Text>
            </View>
          </View>
        )}
        ...
        <Text style={styles.footerNote}>
          KYB CORPORATION • TRADE & RESELLER NETWORK
        </Text>
      </ScrollView>
