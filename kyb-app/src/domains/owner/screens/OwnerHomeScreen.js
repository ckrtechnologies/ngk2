    ...
    >
      <View style={styles.vehicleCardTopRow}>
        ...
        >
          {isActive ? (
            <>
              <CheckCircle2 size={13} color="#E31837" strokeWidth={2.4} />
  ...
  return (
    ...
    >
      ...
      <View style={styles.pickerItemArrow}>
        <ChevronRight size={18} color={isCurrentActive ? '#E31837' : '#94A3B8'} strokeWidth={2.2} />
      </View>
    </TouchableOpacity>
  );
});
          ...
          >
            ...
            >
              <View style={styles.addVehicleCircle}>
                <Plus size={22} color="#E31837" strokeWidth={2.4} />
              </View>
          ...
          <View style={styles.emptyGarageCard}>
            ...
            >
              <View style={styles.addCarCircle}>
                <Plus size={20} color="#E31837" strokeWidth={2.4} />
              </View>
            ...
            >
              ...
              >
                <View style={styles.pickerManualSearchIconBox}>
                  <Search size={18} color="#E31837" strokeWidth={2.2} />
                </View>
                <View style={{ flex: 1 }}>
