          ...
          <View style={styles.modalOverlay}>
            ...
            <View style={styles.modeSegment}>
              ...
              >
                <BookOpen
                  size={15}
                  color={entryMode === 'catalog' ? '#E31837' : '#6B7280'}
                />
                <Text
                  style={[
              ...
              >
                <Edit3
                  size={15}
                  color={entryMode === 'manual' ? '#E31837' : '#6B7280'}
                />
                <Text
                  style={[
                    styles.modeSegmentText,
                      ...
                      <View style={styles.stepSection}>
                        <View style={styles.stepHeaderRow}>
                          ...
                          {selectedManu && (
                            ...
                            >
                              <RotateCcw size={12} color="#E31837" />
                                ...
                                {vehiclesList.slice(0, 3).map((v, i) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <ChevronRight size={16} color="#E31837" />
                                    </TouchableOpacity>
                                  );
                                })}
                              </View>
