    ...
    <View style={styles.container}>
      ...
      <View style={[styles.headerBar, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerSubtitle}>KYB WHOLESALE & SUPPLY</Text>
        </View>
      ...
      >
          ...
          <View style={styles.pendingNoticeCard}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.pendingNoticeBody}>
                Your regional distributor account is currently being vetted by KYB administration. Once verified, your supply hub will automatically be activated on the live Authorized Stockists directory.
              </Text>
            </View>
          </View>
        )}
        ...
        <Text style={styles.footerNote}>
          KYB CORPORATION • WHOLESALE DISTRIBUTOR NETWORK
        </Text>
      </ScrollView>
