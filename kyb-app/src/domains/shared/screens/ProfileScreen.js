    ...
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerSubtitle}>KYB TECHNICAL NETWORK</Text>
        </View>
      ...
      >
        ...
        >
          ...
          <Text style={styles.signOutText}>Sign Out of KYB Technical</Text>
        </TouchableOpacity>
        ...
        <Text style={styles.footerNote}>
          KYB CORPORATION • TECHNICAL PROFILE 2026
        </Text>
      </ScrollView>
