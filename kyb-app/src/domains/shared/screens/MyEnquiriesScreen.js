...
const MyEnquiriesScreen = () => {
  ...
  const navigateToProductScreen = (ticket) => {
    ...
    const partObj = {
      ...
      articleName: info.partName || parsedRef.partName || parsedRef.title || 'KYB Component',
      mfrName: parsedRef.mfrName || parsedRef.brandName || 'KYB Suspension',
                  ...
                  <View style={styles.specsSection}>
                    ...
                    <View style={styles.specsGridCompact}>
                      ...
                      <View style={styles.specsCell}>
                        ...
                        <Text style={styles.specsCellVal}>KYB</Text>
                      </View>
                      <View style={styles.specsCell}>
                        <View style={styles.specsCellLabelRow}>
