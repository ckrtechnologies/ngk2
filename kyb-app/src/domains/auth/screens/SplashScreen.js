  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.centerBox}>
        ...
        >
          <Text style={styles.title}>KYB SUSPENSION</Text>
          <View style={styles.taglineBadge}>
            <Text style={styles.subtitle}>Our Precision, Your Advantage</Text>
          </View>
        </Animated.View>
      </View>
      ...
      <View style={styles.footerContainer}>
        ...
        <Text style={styles.footerText}>INITIALIZING KYB TECHNICAL PORTAL</Text>
      </View>
    </SafeAreaView>
  );
};
...
const styles = StyleSheet.create({
  ...
  logoAura: {
    ...
    backgroundColor: 'rgba(227, 24, 55, 0.35)',
  },
  logoContainer: {
    alignItems: 'center',
    justifyContent: 'center',
