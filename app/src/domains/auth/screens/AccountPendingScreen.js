    ...
    try {
      ...
      if (storedId) {
        ...
        if (fresh?.is_approved === true || fresh?.approval_status === 'approved') {
          ...
          Toast.show({
            ...
            text2: 'Welcome to NGK NTK South Africa.',
          });
          return;
        }
      }
      Toast.show({
        ...
        text2: isRejected
          ...
          : 'Your account is still pending verification by NGK Admin.',
      });
    } catch (e) {
      ...
      <View style={[styles.headerSection, { paddingTop: insets.top + (Platform.OS === 'android' ? 12 : 8) }]}>
        <View style={styles.headerContent}>
          <View style={styles.logoRow}>
            ...
            />
            <View>
              <Text style={styles.brandTitle}>NGK SPARK PLUGS</Text>
      ...
      >
        ...
        <View style={styles.statusHero}>
          ...
          <Text style={styles.heroDescription}>
            {isRejected
              ? 'Your commercial trading application has been reviewed and declined. Please contact NGK compliance if you believe this is in error.'
              : `Thank you for registering as an authorized ${roleName}. For wholesale compliance and authorized trade access, all commercial accounts must be verified by NGK South Africa administration before access is granted.`}
          </Text>
        </View>
