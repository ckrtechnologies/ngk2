...
export default function NotificationsEmptyIllustration({ size = 120 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 96 96" fill="none">
      ...
      {/* Guy wires */}
      <Line x1="48" y1="30" x2="40" y2="52" stroke={COLORS.slate400} strokeWidth="1" strokeLinecap="round" />
      <Line x1="48.5" y1="30" x2="57" y2="52" stroke={COLORS.slate400} strokeWidth="1" strokeLinecap="round" />
      ...
      <G transform="translate(57 8)">
        ...
        <Line x1="3.5" y1="3.5" x2="8.5" y2="8.5" stroke={COLORS.slate400} strokeWidth="1.8" strokeLinecap="round" />
        <Line x1="8.5" y1="3.5" x2="3.5" y2="8.5" stroke={COLORS.slate400} strokeWidth="1.8" strokeLinecap="round" />
      </G>
    </Svg>
  );
}
